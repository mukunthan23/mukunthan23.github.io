...
function fetchData() {
	  d3.csv("https://raw.githubusercontent.com/mukunthan23/mukunthan23.github.io/master/arc_test.csv", function(csv) {
//ustrade_2000-2013
//ustrade_2000-2013_v2
        ...
        for (var y=0; y < countriesGrouped.length; y++) {
            ...
            for (var m=0; m < yearGroup.values.length; m++) {
                ...
                for (var c=0; c < monthGroup.values.length; c++) {
                    ...
                    totalImport= Number(totalImport) + Number(country.Imports)*1;
                    totalExport=Number(totalExport) + Number(country.Exports)*1;
                }
